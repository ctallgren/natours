...
exports.restrictTo = (...roles) => {
  return (req, res, next) => {
    // roles is an array, in this case ["admin, "lead-guide"], now role="user"
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // detta körs som en pre middleware i userModel
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  user.passwordConfirm = req.body.passwordConfirm;
  await user.save();
  // User.findByIdAndUpdate does not work with passwords!
