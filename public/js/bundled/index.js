...
/* es-lint-disable */ var _polyfill = require("@babel/polyfill");
...
},{"@babel/polyfill":"dTCHC","./mapbox":"3zDlz","./login":"7yHem","./updateSettings":"l3cGY","./stripe":"10tSC","./alerts":"6Mcnf"}],"dTCHC":[function(require,module,exports) {
"use strict";
require("./noConflict");
...
const displayMap = (locations)=>{
    mapboxgl.accessToken = "pk.eyJ1IjoiY2hyaXN0YWxsIiwiYSI6ImNsMzhhOHk0dTA1amYzY2pqcGNtenY1cGMifQ.T2PyKEVPVvWNkDhoYbF_vA";
    ...
    locations.forEach((loc)=>{
        ...
        new mapboxgl.Popup({
            offset: 30
        }).setLngLat(loc.coordinates).setHTML(`<p>Day ${loc.description}</p>`).addTo(map);
...
const login = async (email, password)=>{
    ...
    try {
        /* es-lint-disable */ const res = await (0, _axiosDefault.default)({
            method: "POST",
...
/* es-lint-disable */ var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
const stripe = Stripe("pk_test_51L8HWmH8wDrQ157NszA5odkWNjJLl0djWNCNg3cAxJNLaLLkuHyJ9mOYljkI41THGTg5Xb8a3C2XwoLWXeuKylb000T7ezNi82");
